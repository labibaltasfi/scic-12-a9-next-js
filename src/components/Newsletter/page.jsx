            ...
            <div className="bg-white text-[#0B3954] py-8 px-6 w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-2xl rounded-3xl shadow-2xl">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row items-center gap-4 w-full">
                    <input
                        ...
                        className="p-3 sm:p-4 rounded-xl border border-[#1B9AAA] text-[#0B3954] focus:outline-none focus:ring-2 focus:ring-[#7BE495] w-full"
                    />
                    <button
                        type="submit"
                        className="w-full sm:w-auto px-3 py-3 sm:py-4 rounded-xl bg-[#0B3954] text-white font-semibold hover:bg-[#072E42] transition"
                    >
                        Subscribe
                    </button>
                </form>
